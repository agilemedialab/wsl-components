...
final class WSL_FormValidator_GreaterThan extends WSL_FormValidator_Rule
{
	/**
	...
	public function check($data)
	{
        ...
        $this->setDefaultErrorMsg('The field is less than '. $this->params[0]);
