...
/**
 * WSL_FormValidator_LessOrEqualThan
 *
 * PHP version 5
 *
...
final class WSL_FormValidator_LessOrEqualThan extends WSL_FormValidator_Rule
{
	/**
	...
	public function check($data)
	{
        ...
        $this->setDefaultErrorMsg('The field is greater than '. $this->params[0]);
