...
/**
 * WSL_FormValidator_LongerOrEqualThan
 *
 * PHP version 5
 *
...
final class WSL_FormValidator_LongerOrEqualThan extends WSL_FormValidator_Rule
{
	/**
	...
	public function check($data)
	{
        ...
        $this->setDefaultErrorMsg('The field is shorter than '. $this->params[0]);
