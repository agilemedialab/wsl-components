...
/**
 * WSL_FormValidator_GreaterOrEqualThan
 *
 * PHP version 5
 *
...
final class WSL_FormValidator_GreaterOrEqualThan extends WSL_FormValidator_Rule
{
	/**
	...
	public function check($data)
	{
        ...
        $this->setDefaultErrorMsg('The value is less than '. $this->params[0]);
        
	    if ((float)$data < $this->params[0]) {
